...
\codiceverticale{LEAP190725BR0002}
...
Numero di Inventario & \ocr{MB-1990-01} \\
...
\begin{tabularx}{\textwidth}{lX}
%  Analisi Strutturale: & Apertura fascicolo, misurazioni, documentazione fotografica. \\
  %Separazione Componenti: & Disassemblaggio e note di stato componenti singole, valutazione strategia di intervento. \\
%  Consolidamento strutturale: & Il quarto bullone (dx,basso) è spezzato e privo di tiro sul legno. Foro ostruito da parti metalliche. Ricostruzione del foro n. 4 (dx,basso) previa rimozione di parte metallica che ostruiva il passaggio del bullone di serraggio. \\
  Consolidamento strutturale: & Ricostruzione del foro n. 4 (dx,basso) previa rimozione di parte metallica in ostruzione del passaggio bullone di serraggio. \\
...
\begin{flushright}
  \href{https://www.leaphz.net/aleph/index.php/s/sAWrPcW6La8iHnr}{
    \qrcode[height=7cm]{https://www.leaphz.net/aleph/index.php/s/sAWrPcW6La8iHnr}}
\end{flushright}
