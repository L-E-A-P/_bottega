...
Numero di Inventario & \ocr{MB-1990-02} \\
...
\begin{flushright}
  \href{https://www.leaphz.net/aleph/index.php/s/GNrPTdX4wa4fbRG}{
    \qrcode[height=7cm]{https://www.leaphz.net/aleph/index.php/s/GNrPTdX4wa4fbRG}}
\end{flushright}
