...
\codiceverticale{LEAP170725BR0001}
...
Numero di Inventario & \ocr{MB-1980-01} \\
...
\begin{flushright}
  \href{https://www.leaphz.net/aleph/index.php/s/QAHAqtapPgd9d2N}{
    \qrcode[height=7cm]{https://www.leaphz.net/aleph/index.php/s/QAHAqtapPgd9d2N}}
\end{flushright}
